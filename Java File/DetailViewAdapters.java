...
public class DetailViewAdapters extends BaseAdapter {
    ...
    public DetailViewAdapters(Activity activity,ArrayList<HashMap<String, String>> list){
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView=inflater.inflate(R.layout.detail_view_columns, null);
            ...
            txtID=(TextView) convertView.findViewById(R.id.clmID);
        }
        ...
        txtID.setText(map.get(COLUMN_ID));
